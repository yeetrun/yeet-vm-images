...
publisher_identity_env=("GITHUB_JOB=publish-firecracker-runtime" "GITHUB_WORKFLOW_REF=yeetrun/yeet-vm-images/.github/workflows/build-firecracker-runtime.yml@refs/heads/main" "YEET_RUNTIME_WORKFLOW_REPOSITORY=yeetrun/yeet-vm-images" "YEET_RUNTIME_WORKFLOW_FILE_PATH=.github/workflows/build-firecracker-runtime.yml" "YEET_RUNTIME_WORKFLOW_REF=yeetrun/yeet-vm-images/.github/workflows/build-firecracker-runtime.yml@refs/heads/main" "YEET_RUNTIME_WORKFLOW_SHA=$head_commit")
